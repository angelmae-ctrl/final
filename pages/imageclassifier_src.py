...
st.write("UPLOAD AN IMAGE OF SPORT!")
st.write("PREDICTION IS LIMITED TO THE FOLLOWING SPORTS: 🏒 AIR HOCKEY, 🦿 AMPUTEE FOOTBALL, 🏹 ARCHERY, 💪 ARM WRESTLING, 🪓 AXE THROWING, 🤸‍♂️ BALANCE BEAM, 🏇 BARREL RACING, ⚾ BASEBALL, 🏀 BASKETBALL, AND 🎌 BATON TWIRLING.")
...
if my_upload is not None:
    ...
    st.write("by LAMIS, ANGEL MAE 3B.")
''')